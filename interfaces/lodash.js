...
declare module _ {
	declare class LoDashStatic {
		...
		**/
		...
		<T: mixed>(value: T): LoDashObjectWrapper<T>;
	...
	**/
	...
	declare class LoDashWrapperBase<T, TWrapper> {
		/**
	...
	declare class LoDashWrapper<T> extends LoDashWrapperBase<T, LoDashWrapper<T>> { }

	declare class LoDashObjectWrapper<T> extends LoDashWrapperBase<T, LoDashObjectWrapper<T>> { }

	declare class LoDashArrayWrapper<T> extends LoDashWrapperBase<T[], LoDashArrayWrapper<T>> {
	...
	declare class LoDashStatic {
		...
		**/
		...
		chain<T: mixed>(value: T): LoDashObjectWrapper<T>;
	...
	**********/
	...
	declare class LoDashArrayWrapper<T> {
		/**
		* @see _.compact
		**/
	...
	declare class LoDashObjectWrapper<T> {
		/**
		* @see _.forEach
		**/
		forEach<T: mixed>(
	...
	declare class LoDashArrayWrapper<T> {
		...
		* @see _.where
		**/
		where<T, U: mixed>(properties: U): LoDashArrayWrapper<T>;
	}
	...
	declare class DebounceSettings {
		/**
	...
	declare class ThrottleSettings {
	...
	declare class LoDashStatic {
		...
		* @param whereValue _.where style callback
		**/
		findLastKey<W: Dictionary<any>, T>(
			object: T,
			whereValue: W): string;
	}
	...
	declare class TemplateExecutor {
		(...data: any[]): string;
		source: string;
	}
	...
	declare class MemoVoidIterator<T, TResult> {
		(prev: TResult, curr: T, indexOrKey: any, list?: T[]): void;
	}
	declare class MemoIterator<T, TResult> {
		(prev: TResult, curr: T, indexOrKey: any, list?: T[]): TResult;
	}
	/*
	declare class MemoListIterator<T, TResult> {
		(prev: TResult, curr: T, index: number, list?: T[]): TResult;
	}
	declare class MemoObjectIterator<T, TResult> {
	...
	*/
	...
	// Common declare class between Arrays and jQuery objects
...
declare module "lodash" {
	declare var exports: _.LoDashStatic;
}
/* jshint ignore:end */
